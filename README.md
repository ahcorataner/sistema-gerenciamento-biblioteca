...
&#x20;   Projeto de modelagem e implementação de banco de dados relacional para gerenciamento de bibliotecas acadêmicas utilizando PostgreSQL.
...
SELECT COUNT(\*) AS total\_emprestimos
...
&#x20;   COUNT(l.id\_livro) AS quantidade\_livros

FROM categoria c

JOIN livro l

ON c.id\_categoria = l.id\_categoria

GROUP BY c.descricao

HAVING COUNT(l.id\_livro) >= 2;
...
CREATE OR REPLACE FUNCTION quantidade\_emprestimos(p\_id\_usuario INT)
...
📧 \[carvalho.kaline@discente.ufma.br](mailto:carvalho.kaline@discente.ufma.br)
...
📧 \[guilherme.sameneses@discente.ufma.br](mailto:guilherme.sameneses@discente.ufma.br)
